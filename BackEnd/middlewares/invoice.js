...
console.log("Something happenned here")
console.log(options)
getInvoice(options)
...
function getDeliveryItemsHTML(items){
    ...
    <div class="table-row">
        ...
        <div class=" table-cell w-[10%] text-center">${item.quantity}</div>
        <div class=" table-cell w-2/12 text-center">₹${item.price}</div>
        <div class=" table-cell w-2/12 text-center">₹${item.quantity*item.price}</div>
    </div>
    `
    }
    return data
...
<body>
    <div class="p-10">
        ...
        <div class="flex items-start justify-center">
            <div class="flex-1">
                <div class="w-60 pb-6">
                    <img class="w-40" src="./logo/download.jpg" alt="Logo">
                </div>
            ...
            <div class="flex items-end flex-col">
                ...
                <div class="flex">
                    <div class="flex flex-col items-end w-[12rem] text-right">
                        <p class="py-1">${options.delivery_date}, time is ${options.delivery_time}</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class=" pt-20 pr-10 text-right">
            <p class="text-gray-400">discount is : <span class="pl-24 text-black">₹${options.percentdiscount}</span></p>
...
async function getInvoice(options) {
    return new Promise(async (resolve,reject) => {
        try {
            console.log(getDeliveryItemsHTML)
